...
const EMPTY_OBJECT_DRAFT = {
  ...
  facadeComplexity: 'Легкий' as string,
  surroundings: 'Загород ненаселённый' as string,
  area: 100,
  roomsMain: 3,
  roomsAux: 1,
  roomsTech: 1,
...
export function ContractSlotFinder({
  ...
  const formObject: ProjectObject = useMemo(() => {
    ...
    return {
      ...
      facadeComplexity: objectDraft.facadeComplexity as ProjectObject['facadeComplexity'],
      surroundings: objectDraft.surroundings as ProjectObject['surroundings'],
